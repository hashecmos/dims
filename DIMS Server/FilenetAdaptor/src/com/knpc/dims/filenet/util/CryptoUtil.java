...
public class CryptoUtil {
   ...
   /*public static void main(String[] args) {
		...
		System.out.println(CryptoUtil.encryptString("test"));
		
		System.out.println(CryptoUtil.decryptString("eZXwpOtiYlL6lViB2eS3RA==;"));
		System.out.println(CryptoUtil.decryptString("5l35XWdB4FcQBWN5CsrESg=="));
	}*/
}
