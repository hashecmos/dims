package com.knpc.dims.pdf.headerfooter;
...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    private void addHeader(PdfWriter writer){
        ...
        try {
            ...
            // add image
            Image logo = Image.getInstance("C:\\Users\\p8admin\\ICMWorkSpace\\DIMS\\WebContent\\images\\logo-new.png");
            header.addCell(logo);
    ...
    private void addFooter(PdfWriter writer, Document document){
        ...
        try {
        	...
        	String fomattedDate = formatter.format(dateCreated);
            footer.addCell(new Phrase("Report executed on : "+fomattedDate, new Font(Font.FontFamily.HELVETICA, 8)));
