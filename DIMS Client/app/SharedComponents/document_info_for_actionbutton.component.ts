...
@Component({
  selector: 'document_info_for_actionbutton',
  templateUrl: 'app/SharedComponents/document_info_for_actionbutton.component.html'
})

export class DocumentInfoforactionbutton{
